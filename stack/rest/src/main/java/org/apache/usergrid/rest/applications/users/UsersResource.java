...
public class UsersResource extends ServiceResource {
    ...
    public JSONWithPadding executePost( @Context UriInfo ui, String body,
        ...
        if(logger.isDebugEnabled()) logger.debug("UsersResource.executePost: body = " + body);
        ...
        if(logger.isDebugEnabled()) logger.debug("Confirmation required: {} Activated: {}", confRequred, activated);

...
public class ServiceManager {
    ...
    public Service getService( String serviceType, boolean fallback ) {
        ...
        if(logger.isDebugEnabled()) logger.debug( "Looking up service pattern: {}", serviceType );
        ...
        if ( service != null ) {
            if(logger.isDebugEnabled()) logger.debug( "Returning service instance: {}", service.getClass() );
        }
    ...
    private static Class<Service> findClass( String classname ) {
        ...
        Class<Service> cls;
        try {
            if(logger.isDebugEnabled()) logger.debug( "Attempting to instantiate service class {}", classname );
